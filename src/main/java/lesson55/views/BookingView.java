package lesson55.views;

import lesson55.models.Reservation;
import lesson55.models.Table;
import lesson55.presenters.View;
import lesson55.presenters.ViewObserver;
...
public class BookingView implements View {
    ...
    public void printChangeReservationTableResult(int reservationNo) {
        System.out.printf("Бронирование изменено. Номер вашей брони: #%d\n", reservationNo);
    }
